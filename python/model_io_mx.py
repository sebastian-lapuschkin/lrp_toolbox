...
from mxmodules import Linear, Rect, Sequential, SoftMax, Sequential,Linear,Tanh,Rect,SoftMax,Convolution,Flatten,SumPool,MaxPool
...
def _read_txt(path, ctx, dtype):
    ...
    def _read_txt_helper(path, ctx, dtype):
        ...
        return Sequential(modules, ctx=ctx)
