...
void HingeLossMultiLabelLayer<Dtype>::Forward_cpu(
	...
	//LOG(INFO) << " num,dim,count " << num << "," << dim << "," << count;
	//LOG(INFO) << " " << bottom[0]->shape_string() << " vs "
...
template<typename Dtype>
void HingeLossMultiLabelLayer<Dtype>::Backward_cpu(
...
REGISTER_LAYER_CLASS (HingeLossMultiLabel);
